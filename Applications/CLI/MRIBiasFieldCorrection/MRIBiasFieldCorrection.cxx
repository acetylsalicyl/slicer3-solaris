      ...
      itk::Image< float, 3 >::Pointer outputImage )
  {
    ...
    try
    {
      ...
      for (int k=0; k < outDim[2]; k++)
      {
        ...
        if (clipExtent[4] < wholeExtent[4]) {clipExtent[4] = wholeExtent[4];}
        if (clipExtent[5] < wholeExtent[4]) {clipExtent[5] = wholeExtent[4];}

        if (clipExtent[4] > wholeExtent[5]) {clipExtent[4] = wholeExtent[5];}
        if (clipExtent[5] > wholeExtent[5]) {clipExtent[5] = wholeExtent[5];}
        ...
        for (int j=0; j < outDim[1]; j++)
        {
          ...
          if (clipExtent[2] < wholeExtent[2]) clipExtent[2] = wholeExtent[2];
          if (clipExtent[3] < wholeExtent[2]) clipExtent[3] = wholeExtent[2];

          if (clipExtent[2] > wholeExtent[3]) clipExtent[2] = wholeExtent[3];
          if (clipExtent[3] > wholeExtent[3]) clipExtent[3] = wholeExtent[3];
          ...
          for (int i=0; i < outDim[0]; i++)
          {
            ...
            if (clipExtent[0] < wholeExtent[0]) clipExtent[0] =wholeExtent[0];
            if (clipExtent[1] < wholeExtent[0]) clipExtent[1] =wholeExtent[0];

            if (clipExtent[0] > wholeExtent[1]) clipExtent[0] =wholeExtent[1];
            if (clipExtent[1] > wholeExtent[1]) clipExtent[1] =wholeExtent[1];
