...
void vtkSlicerWelcomeGUI::BuildGUI ( ) 
{
  ...
  this->SlicerWelcomeIcons = vtkSlicerWelcomeIcons::New();
    ...
    const char *ack = "This work was supported by NA-MIC, NAC, BIRN, NCIGT, CTSC and the Slicer Community. See <a>http://www.slicer.org</a> for details. We would also like to express our sincere thanks to members of the Slicer User Community who have helped us to design the contents of this Welcome Module, and whose feedback continues to improve functionality, usability and Slicer user experience. This module was implemented by Wendy Plesniak, Sonia Pujol, Ron Kikinis and Steve Pieper.\n";    
    txt->SetText ( ack );
